...
class UniversalNoRecoilApp:
    def __init__(self, root):
        self.root = root
        self.root.title("🎯 Strong No Recoil - Universal Gaming Utility")
    ...
    def create_startup_screen(self):
        ...
        subtitle_label = tk.Label(self.startup_frame, text="Universal Gaming Utility", 
                                 font=('Arial', 12), 
                                 fg='#cccccc', bg='#0a0a0a')
    ...
    def initialize_app(self):
        ...
        steps = [
            ...
            ("Setting up universal controls...", 0.6),
    ...
    def setup_ui(self):
        ...
        subtitle_label = tk.Label(title_frame, text="Universal Gaming Utility", 
                                 font=('Arial', 10), 
                                 fg='#cccccc', bg='#0a0a0a')
        subtitle_label.pack()
    ...
    def check_mouse_button(self, button):
        """Check if mouse button is pressed using universal method"""
        try:
            # Try using keyboard library for mouse detection
    ...
    def move_mouse(self, dx, dy):
        """Move mouse using universal method"""
        try:
    ...
    def recoil_loop(self):
        """Recoil control loop with universal detection"""
        while self.running:
    ...
    def rapid_fire_loop(self):
        """Rapid fire loop with universal detection"""
        while self.running:
