...
class WorkingGameApp:
    def __init__(self, root):
        self.root = root
        self.root.title("🎯 Strong No Recoil - Working Game Utility")
    ...
    def create_startup_screen(self):
        ...
        subtitle_label = tk.Label(self.startup_frame, text="Working Game Utility", 
                                 font=('Arial', 12), 
                                 fg='#cccccc', bg='#1a1a2e')
    ...
    def setup_ui(self):
        ...
        subtitle_label = tk.Label(title_frame, text="Working Game Utility", 
                                 font=('Arial', 10), 
                                 fg='#cccccc', bg='#1a1a2e')
        subtitle_label.pack()
